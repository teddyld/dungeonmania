...
public class PortalsTest {
    ...
    @Test
    @Tag("7-7")
    @DisplayName("Test portals work with adjacent walls")
    public void testTeleportationWithWalls() {
        DungeonManiaController controller = new DungeonManiaController();
        DungeonResponse preTeleportResponse = controller.newGame(
            "d_PortalsTest_testTeleportationWithWalls", "c_PortalsTest_testTeleportationBothWays");
        EntityResponse player = TestUtils.getPlayer(preTeleportResponse).get();
        ...
        // Only available tile is above the second portal
